...
import com.hxm.imagepicker.adapter.ImagePageAdapter;
import com.hxm.imagepicker.bean.ImageItem;
import com.hxm.imagepicker.util.Utils;
import com.hxm.imagepicker.view.ViewPagerFixed;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mCurrentPosition指上个界面点击的图片的position，不是选中状态的position
        ...
        mViewPager.setPageMargin(Utils.dp2px(this, 5));
        //初始化当前页面的状态
