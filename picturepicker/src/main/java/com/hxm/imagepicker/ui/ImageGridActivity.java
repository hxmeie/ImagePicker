package com.hxm.imagepicker.ui;
...
import com.hxm.imagepicker.ImageDataSource;
import com.hxm.imagepicker.ImagePicker;
import com.hxm.imagepicker.R;
import com.hxm.imagepicker.adapter.ImageFolderAdapter;
import com.hxm.imagepicker.adapter.ImageRecyclerAdapter;
import com.hxm.imagepicker.adapter.ImageRecyclerAdapter.OnImageItemClickListener;
import com.hxm.imagepicker.bean.ImageFolder;
import com.hxm.imagepicker.bean.ImageItem;
import com.hxm.imagepicker.view.FolderPopUpWindow;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.getExtras() != null) {
            ...
            ArrayList<ImageItem> images = intent.getParcelableArrayListExtra(EXTRAS_IMAGES);
